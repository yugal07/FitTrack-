const workouts = [
  ...
  },
  {
    ...
    description:
      'A focused core workout that can be completed in under 20 minutes.',
    type: 'strength',
    fitnessLevel: 'beginner',
    isCustom: false,
    duration: 20,
  ...
  },
  {
    ...
    description:
      'A comprehensive strength workout for those with some fitness experience.',
    type: 'strength',
  ...
  },
  {
    ...
    description:
      'A high-intensity interval training workout to boost cardio fitness and burn calories.',
    type: 'hiit',
    fitnessLevel: 'intermediate',
    isCustom: false,
    duration: 25,
  ...
  },
  {
    ...
    description:
      'A targeted workout for strengthening and toning the lower body.',
    type: 'strength',
    fitnessLevel: 'beginner',
    isCustom: false,
    duration: 35,
