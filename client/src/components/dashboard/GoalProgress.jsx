  ...
  if (activeGoals.length === 0) {
    return (
      <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        <h2 className="text-lg font-medium text-gray-900 dark:text-white">Goal Progress</h2>
        <div className="mt-4 text-center py-10">
          <p className="text-gray-500 dark:text-gray-400">No active goals at the moment.</p>
          <button 
    ...
    <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
      ...
      {activeGoals.length > 3 && (
        <div className="mt-6 text-center">
          <a href="/goals" className="text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300">
