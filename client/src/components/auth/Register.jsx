...
const ProgressIndicator = memo(({ step }) => (
  <div className="mb-6">
    ...
    <div className="flex justify-between mt-2 text-xs text-gray-500 dark:text-gray-400">
      <span className={step === 1 ? 'text-indigo-600 dark:text-indigo-400 font-medium' : ''}>Account</span>
      <span className={step === 2 ? 'text-indigo-600 dark:text-indigo-400 font-medium' : ''}>Personal</span>
      <span className={step === 3 ? 'text-indigo-600 dark:text-indigo-400 font-medium' : ''}>Profile</span>
      <span className={step === 4 ? 'text-indigo-600 dark:text-indigo-400 font-medium' : ''}>Goals</span>
    </div>
  </div>
));

const AccountStep = memo(({ formData, errors, error, updateFormData, showPassword, setShowPassword, passwordStrength, handleNext }) => (
  <div className="space-y-5">
    <div className="text-center">
      <h3 className="text-lg font-medium text-gray-900 dark:text-white">Account Information</h3>
      <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Create your secure login credentials</p>
    </div>
        ...
        <div className="mt-2">
          <div className="flex justify-between text-xs mb-1">
            ...
            <span className={`font-medium ${
              ...
              passwordStrength >= 50 ? 'text-yellow-600 dark:text-yellow-400' : 'text-red-600 dark:text-red-400'
            }`}>
...
const PersonalInfoStep = memo(({ formData, errors, updateFormData, handleNext, handleBack }) => (
  <div className="space-y-5">
    <div className="text-center">
      <h3 className="text-lg font-medium text-gray-900 dark:text-white">Personal Information</h3>
      <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Help us personalize your experience</p>
    </div>
...
const ProfileStep = memo(({ formData, errors, updateFormData, handleNext, handleBack }) => (
  <div className="space-y-5">
    <div className="text-center">
      <h3 className="text-lg font-medium text-gray-900 dark:text-white">Profile Details</h3>
      <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">This helps us provide better recommendations</p>
    </div>
        ...
        {[
          ...
          <label key={level.value} className="relative cursor-pointer">
            ...
            <div className={`border-2 rounded-lg p-3 transition-all duration-200 ${
              ...
              <div className="text-center">
                <div className="font-medium text-gray-900 dark:text-white text-sm">{level.label}</div>
...
const GoalsStep = memo(({ formData, errors, updateFormData, toggleGoal, onSubmit, handleBack, loading }) => (
  <div className="space-y-5">
    <div className="text-center">
      <h3 className="text-lg font-medium text-gray-900 dark:text-white">Your Fitness Goals</h3>
      <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">What would you like to achieve? (Select all that apply)</p>
    </div>
      ...
      {[
        ...
        <label key={goal.value} className="relative cursor-pointer">
          <input
            ...
            className="sr-only"
          />
          <div className={`border-2 rounded-lg p-3 transition-all duration-200 hover:shadow-sm ${
            ...
            <div className="text-center">
              ...
              <div className="font-medium text-gray-900 dark:text-white text-sm">{goal.label}</div>
            </div>
          </div>
        </label>
      ))}
      ...
      <div className="flex">
        ...
        <div className="ml-3 flex-1">
          <p className="text-sm text-blue-700 dark:text-blue-300">
            Based on your goals, we'll customize your workout plans, nutrition advice, and progress tracking.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="flex items-start">
      ...
      <label htmlFor="acceptTerms" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
        I agree to the{' '}
        <a href="#" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">Terms of Service</a>
        {' '}and{' '}
