...
const MeasurementsTracker = () => {
  ...
  const handleAddMeasurement = async (measurementData) => {
    try {
      ...
      if (editingMeasurement) {
        ...
        await api.put(`/api/profiles/measurements/${editingMeasurement._id}`, measurementData);
      ...
      setError(err.response?.data?.error?.message || 'Failed to save measurement');
  ...
  const handleDeleteMeasurement = async (id) => {
    ...
    try {
      ...
      setError(err.response?.data?.error?.message || 'Failed to delete measurement');
      ...
      {measurements.length > 0 && (
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white">Progress Chart</h3>
      ...
      <div>
        ...
        {loading && measurements.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="mt-3 text-sm text-gray-600 dark:text-gray-400">Loading measurements...</p>
          </div>
        ) : measurements.length === 0 ? (
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead className="bg-gray-50 dark:bg-gray-800">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Body Fat</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Chest</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Waist</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Hips</th>
