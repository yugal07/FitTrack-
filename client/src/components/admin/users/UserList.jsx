                  ...
                  {users.length > 0 ? (
                    users.map(user => (
                      ...
                      >
                        ...
                        <td className='px-6 py-4 whitespace-nowrap'>
                          <span
                            className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${user.role === 'admin' ? 'bg-purple-100 dark:bg-purple-800 text-purple-800 dark:text-purple-100' : 'bg-green-100 dark:bg-green-800 text-green-800 dark:text-green-100'}`}
                          >
                            {user.role}
                          </span>
                        </td>
