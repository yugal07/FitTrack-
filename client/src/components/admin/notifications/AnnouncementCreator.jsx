...
const AnnouncementCreator = () => {
  ...
  const onSubmit = async data => {
    try {
      ...
      setError(
        err.error?.message || 'Failed to send announcement. Please try again.'
      );
    } finally {
      setLoading(false);
    }
        ...
        <div className='space-y-4'>
          <div className='flex'>
            ...
            <div className='ml-3'>
              ...
              <p className='mt-1 text-sm text-gray-500 dark:text-gray-400'>
                Keep your announcement clear and to the point. Users are more
                likely to read and understand shorter messages.
              </p>
            </div>
          </div>
          ...
          <div className='flex'>
            ...
            <div className='ml-3'>
              ...
              <p className='mt-1 text-sm text-gray-500 dark:text-gray-400'>
                Create informative titles that give users a clear idea of what
          ...
          <div className='flex'>
            ...
            <div className='ml-3'>
              ...
              <p className='mt-1 text-sm text-gray-500 dark:text-gray-400'>
                Send announcements only to users who would find the information
                relevant to prevent notification fatigue.
              </p>
            </div>
          </div>
          ...
          <div className='flex'>
            ...
            <div className='ml-3'>
              ...
              <p className='mt-1 text-sm text-gray-500 dark:text-gray-400'>
                When appropriate, include a clear call to action to help users
