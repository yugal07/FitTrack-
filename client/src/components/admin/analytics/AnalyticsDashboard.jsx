    ...
    <div className="mt-4">
      {data.map((item, index) => (
        <div key={index} className="flex items-center mb-2">
          <div className="w-24 text-sm text-gray-600 dark:text-gray-400">{item[nameKey]}</div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Filter by Date Range</h2>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-2">
        ...
        {/* Workout Activity */}
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          <h2 className="text-lg font-medium text-gray-900 dark:text-white">Workout Activity</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Monthly completed workouts</p>
        ...
        {/* Popular Workouts */}
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          <h2 className="text-lg font-medium text-gray-900 dark:text-white">Popular Workouts</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Most frequently completed workouts</p>
        ...
        {/* User Fitness Levels */}
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          <h2 className="text-lg font-medium text-gray-900 dark:text-white">User Fitness Levels</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Distribution of users by fitness level</p>
