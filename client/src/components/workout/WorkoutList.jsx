      ...
      {showDetail && selectedWorkout ? (
        ...
        <>
          ...
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700 mb-6">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">Filter Workouts</h3>
          ...
          {loading ? (
            ...
            <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
              ...
              <h3 className="mt-2 text-base font-medium text-gray-900 dark:text-white">No workouts found</h3>
            ...
            <div className="space-y-6">
              {Object.entries(groupedWorkouts).map(([monthYear, monthlyWorkouts]) => (
                <div key={monthYear}>
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center">
                                <div className="flex-shrink-0 h-10 w-10 bg-indigo-100 dark:bg-indigo-900 rounded-full flex items-center justify-center text-indigo-600 dark:text-indigo-400">
                                  {getWorkoutTypeIcon(workout.workoutId?.type || 'custom')}
                                </div>
                                <div className="ml-4">
                                  <div className="text-sm font-medium text-gray-900 dark:text-white">
                                    {workout.workoutId?.name || 'Custom Workout'}
                                  </div>
