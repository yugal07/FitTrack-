...
const ScheduledWorkoutList = () => {
  ...
  const fetchWorkouts = async () => {
    try {
      ...
      const response = await api.get(`/api/scheduled-workouts?completed=${completed}`);
      ...
      <Card>
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="mt-4 text-lg font-medium text-gray-900 dark:text-white">No {activeTab} workouts</h3>
            <p className="mt-1 text-gray-500 dark:text-gray-400">
              {activeTab === 'upcoming' 
                  ...
                  >
                      ...
                      <div className="flex items-center">
                        <div>
                          ...
                          <div className="text-xs text-gray-500 dark:text-gray-400">
                            {workout.workoutId?.type ? workout.workoutId.type.charAt(0).toUpperCase() + workout.workoutId.type.slice(1) : 'Custom'}
                          </div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900 dark:text-white">
                        {format(new Date(workout.scheduledFor), 'EEE, MMM d, yyyy')}
                      </div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">
