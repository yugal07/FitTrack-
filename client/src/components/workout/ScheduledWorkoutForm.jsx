...
const ScheduledWorkoutForm = () => {
  ...
  useEffect(() => {
    ...
    const fetchScheduledWorkout = async () => {
      try {
        ...
        // Convert date to appropriate format for the form
    ...
    if (id) {
      ...
      // For new workout, set default date to today
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(isEdit ? 'Failed to update workout' : 'Failed to schedule workout');
    }
  };
