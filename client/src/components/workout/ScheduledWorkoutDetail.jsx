      ...
      <div className='bg-white dark:bg-gray-800 shadow rounded-lg p-6'>
        <div className='space-y-6'>
            ...
            <div className='mt-2 grid grid-cols-1 md:grid-cols-2 gap-4'>
              <div>
                ...
                <p className='text-lg font-medium text-gray-900 dark:text-white'>
                  ...
                  at {format(new Date(scheduledWorkout.scheduledFor), 'h:mm a')}
                </p>
              </div>
              <div>
                <p className='text-sm text-gray-500 dark:text-gray-400'>
              ...
              <div className='bg-gray-50 dark:bg-gray-700 rounded-lg p-4'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  ...
                  <div>
                    ...
                    <p className='font-medium text-gray-900 dark:text-white'>
                      {scheduledWorkout.workoutId.fitnessLevel
                        ? scheduledWorkout.workoutId.fitnessLevel
                            .charAt(0)
                            .toUpperCase() +
                          scheduledWorkout.workoutId.fitnessLevel.slice(1)
                        : 'All levels'}
                    </p>
                  </div>
                </div>
                <div className='mt-4'>
                  <Button
                    variant='outline'
                    onClick={() =>
                      navigate(`/workouts/${scheduledWorkout.workoutId._id}`)
                    }
                    className='text-sm'
                  >
          ...
          <div className='border-t border-gray-200 dark:border-gray-700 pt-6 flex flex-wrap justify-end gap-3'>
            ...
            <Button variant='secondary' onClick={handleEditWorkout}>
              Edit
            </Button>
            {!scheduledWorkout.isCompleted && (
              <Button
