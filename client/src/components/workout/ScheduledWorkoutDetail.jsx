            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
              <div className="flex items-center gap-2">
                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                  ...
                  {scheduledWorkout.isCompleted ? 'Completed' : isWorkoutInPast ? 'Overdue' : 'Scheduled'}
                </span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                  ...
                  <div className="text-lg font-semibold text-gray-900 dark:text-white">
                    {format(new Date(scheduledWorkout.scheduledFor), 'EEEE, MMMM d')}
                  </div>
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-800 dark:text-blue-100">
                    {scheduledWorkout.workoutId.type ? 
                      scheduledWorkout.workoutId.type.charAt(0).toUpperCase() + scheduledWorkout.workoutId.type.slice(1) 
                      : 'Custom'
                    }
                  </span>
                </div>
                                ...
                                <div className="flex items-start justify-between mb-3">
                                  <div className="flex-1">
                                    ...
                                    <div className="flex flex-wrap gap-1">
                                      ...
                                      {exercise.exerciseId?.muscleGroups?.slice(0, 2).map((muscle, idx) => (
                                        <span
                                          key={idx}
                                      ...
                                      {exercise.exerciseId?.muscleGroups?.length > 2 && (
                                        <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-gray-600 dark:text-gray-200">
                                          +{exercise.exerciseId.muscleGroups.length - 2} more
                                        </span>
                                      )}
                                    </div>
                                    ...
                                    {exercise.notes && (
                                      <div className="mt-3 p-2 bg-yellow-50 dark:bg-yellow-900/20 rounded border-l-3 border-yellow-400">
                                        <div className="text-xs text-yellow-700 dark:text-yellow-300 font-medium">Note:</div>
          ...
          <div className="space-y-6">
                ...
                {!scheduledWorkout.isCompleted && (
                  ...
                  >
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1.5a3.5 3.5 0 110 7H9V10zm0 0V9a2 2 0 012-2h1.5a3.5 3.5 0 010 7H12" />
                    </svg>
            ...
            <Card className="p-4 sm:p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium text-gray-900 dark:text-white">{scheduledWorkout.duration} min</span>
                </div>
                {scheduledWorkout.workoutId && (
                  <>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-500 dark:text-gray-400">Exercises</span>
            ...
            {!scheduledWorkout.isCompleted && !isWorkoutInPast && (
              <Card className="p-4 sm:p-6 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border-indigo-200 dark:border-indigo-700">
                <h3 className="text-lg font-semibold text-indigo-900 dark:text-indigo-100 mb-2">Upcoming</h3>
                <p className="text-sm text-indigo-700 dark:text-indigo-300">
                  Your workout is scheduled for {format(new Date(scheduledWorkout.scheduledFor), 'EEEE')} at {format(new Date(scheduledWorkout.scheduledFor), 'h:mm a')}
                </p>
              </Card>
            )}
          </div>
