    ...
    <Card title="Nutrition Summary" className="h-full">
      ...
      <div className="mb-6">
        <div className="flex justify-between items-baseline mb-1">
          ...
          <div className="text-right">
            <span className="text-2xl font-bold text-gray-900 dark:text-white">{nutritionLog.totalCalories}</span>
      ...
      <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg mb-6">
        <div className="flex items-center mb-2">
          <div className={`flex-1 text-${isCalorieDeficit ? 'green' : 'red'}-600 dark:text-${isCalorieDeficit ? 'green' : 'red'}-400`}>
            <div className="text-sm font-medium">Remaining</div>
            <div className="text-xl font-bold">{isCalorieDeficit ? caloriesRemaining : -caloriesRemaining} kcal</div>
          </div>
          ...
          <div className="flex-1 text-gray-700 dark:text-gray-300">
            ...
            <div className="text-xl font-bold">{nutritionLog.totalCalories} kcal</div>
          </div>
        </div>
      </div>
      ...
      {/* Macros */}
      <div className="mb-6">
        <h4 className="text-md font-medium text-gray-800 dark:text-gray-200 mb-4">Macronutrients</h4>
        ...
        <div className="mb-4">
          <div className="flex justify-between items-end mb-1">
            <div className="flex items-center">
              ...
              <h5 className="text-sm font-medium text-gray-700 dark:text-gray-300">Protein</h5>
            </div>
            <div className="text-right">
          ...
          <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400 mt-1">
            <span>{Math.round((nutritionLog.totalProtein / targets.protein) * 100)}% of goal</span>
            <span>{targets.protein - nutritionLog.totalProtein}g remaining</span>
          </div>
        </div>
        ...
        <div className="mb-4">
          <div className="flex justify-between items-end mb-1">
            <div className="flex items-center">
              ...
              <h5 className="text-sm font-medium text-gray-700 dark:text-gray-300">Carbs</h5>
            </div>
            <div className="text-right">
          ...
          <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400 mt-1">
            <span>{Math.round((nutritionLog.totalCarbs / targets.carbs) * 100)}% of goal</span>
        ...
        <div className="mb-6">
          <div className="flex justify-between items-end mb-1">
            <div className="flex items-center">
              ...
              <h5 className="text-sm font-medium text-gray-700 dark:text-gray-300">Fat</h5>
            </div>
            <div className="text-right">
          ...
          <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400 mt-1">
            <span>{Math.round((nutritionLog.totalFat / targets.fat) * 100)}% of goal</span>
      ...
      <div>
        <h4 className="text-md font-medium text-gray-800 dark:text-gray-200 mb-2">Macronutrient Ratio</h4>
