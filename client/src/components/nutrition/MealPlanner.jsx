        ...
        {editingDay && editingMeal && (
          <div className='bg-gray-50 dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700 mb-6'>
            <h3 className='text-md font-medium text-gray-800 dark:text-gray-200 mb-2'>
              Edit {editingMeal.charAt(0).toUpperCase() + editingMeal.slice(1)}{' '}
              for {format(new Date(editingDay), 'EEEE, MMM d')}
            </h3>
                  ...
                  >
                    <td className='px-6 py-4 whitespace-nowrap'>
                      <div className='flex flex-col'>
                        <span
                          className={`text-sm font-medium ${isToday ? 'text-blue-700 dark:text-blue-300' : 'text-gray-900 dark:text-white'}`}
                        >
                          {format(day, 'EEEE')}
                        </span>
