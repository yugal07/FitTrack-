...
const GoalList = ({ goals, loading, onGoalUpdated }) => {
  ...
  const completedGoals = goalsToDisplay.filter(
    goal => goal.status === 'completed'
  );
  const abandonedGoals = goalsToDisplay.filter(
                  ...
                  <div className='mt-4'>
                    ...
                    <div className='mt-2 w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5'>
                      <div
                        ...
                        style={{
                          width: `${Math.min(100, Math.round((goal.currentValue / goal.targetValue) * 100))}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                    ...
                    <div className='flex flex-col space-y-4'>
                      <div className='flex flex-col sm:flex-row sm:space-x-4'>
                        ...
                        <div>
                          ...
                          <span className='text-sm text-gray-600 dark:text-gray-400'>
                            {goal.targetDate &&
                            isValid(new Date(goal.targetDate))
                              ? Math.max(
                                  0,
                                  Math.ceil(
                      ...
                      <div className='flex flex-col sm:flex-row sm:items-end space-y-2 sm:space-y-0 sm:space-x-4'>
                        ...
                        <div className='flex space-x-2'>
                          <Button
                            ...
                            disabled={
                              updateLoading ||
                              progressValue[goal._id] === undefined ||
                              progressValue[goal._id] === ''
                            }
